                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control" id="tanggal" name="tanggal"
                            value="<?= $pembelian ?  $pembelian->tanggal : "" ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <tbody id="purchaseItems">
                        <?php if (!empty($pembelian)) : ?>
                            ...
                            <?php foreach ($detail_pembelian->getData("tb_detail_pembelian", ["id_pembelian" => $pembelian->id_pembelian])->result() as $detail) : ?>
                                ...
                                <tr data-iddetail="<?= $detail->id_detail_pembelian ?>" data-id="<?= $detail->id_obat ?>"
                                    data-rownum="<?= $num++ ?>">
    ...
    <script>
        ...
        $("body").on("submit", "#purchaseForm", function(e) {
            ...
            const urlForm = data.id_pembelian.length == 0 ? "http://localhost/skripsi/master/pembelian/tambah" :
                "http://localhost/skripsi/master/pembelian/update";

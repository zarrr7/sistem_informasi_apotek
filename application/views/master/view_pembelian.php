                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= base_url('master/pembelian/form') ?>"
                                class="btn bg-gradient-success ml-auto"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-hover dt-responsive"
                                ...
                                <tbody>
                                    <tr>
                                        <td><?= $num++ ?></td>
                                        <td><?= $pbl->tanggal ?></td>
                                        <td><?= $supplier->get_data("tb_supplier", ["id_supplier" => $pbl->id_supplier])->row()->supplier ?></td>
                                        <td><?= $detail->getData("tb_detail_pembelian", ['id_pembelian' => $pbl->id_pembelian])->num_rows() ?></td>
                                        <td class="rupiah"><?= $pbl->total ?></td>
                                        <td>
                                            <a href="<?= base_url('master/pembelian/form/' . $pbl->id_pembelian) ?>"
                                                class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
                                            <a href="<?= base_url('master/pembelian/delete/' . $pbl->id_pembelian) ?>"
